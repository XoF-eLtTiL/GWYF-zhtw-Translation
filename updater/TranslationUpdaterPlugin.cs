...
[BepInPlugin("codex.gwyf.translationupdater", "GWYF Translation Updater", "0.1.1")]
public sealed class TranslationUpdaterPlugin : BaseUnityPlugin
{
    ...
    private const string ManifestUrl = "https://raw.githubusercontent.com/XoF-eLtTiL/GWYF-zhtw-Translation/main/manifest.txt";
    private const string RawBaseUrl = "https://raw.githubusercontent.com/XoF-eLtTiL/GWYF-zhtw-Translation/main/translations";
    ...
    private void Awake()
    {
        ...
        EnsureFileExists(_readmePath,
            ...
            "4. The updater only writes files; it never executes downloaded content.");
